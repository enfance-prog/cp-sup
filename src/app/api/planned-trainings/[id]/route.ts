  ...
  try {
    ...
    const updatedPlannedTraining = await prisma.plannedTraining.update({
      ...
      data: {
        ...
        transportationFee: body.transportationFee !== undefined ? (body.transportationFee ? parseInt(body.transportationFee) : null) : undefined,
        welfareFee: body.welfareFee !== undefined ? (body.welfareFee ? parseInt(body.welfareFee) : null) : undefined,
        entertainmentFee: body.entertainmentFee !== undefined ? (body.entertainmentFee ? parseInt(body.entertainmentFee) : null) : undefined,
        advertisingFee: body.advertisingFee !== undefined ? (body.advertisingFee ? parseInt(body.advertisingFee) : null) : undefined,
        bookFee: body.bookFee !== undefined ? (body.bookFee ? parseInt(body.bookFee) : null) : undefined,
        expenseNote: body.expenseNote !== undefined ? (body.expenseNote || null) : undefined,
