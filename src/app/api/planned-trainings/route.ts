  ...
  try {
    ...
    const plannedTraining = await prisma.plannedTraining.create({
      data: {
        ...
        transportationFee: body.transportationFee ? parseInt(body.transportationFee) : null,
        welfareFee: body.welfareFee ? parseInt(body.welfareFee) : null,
        entertainmentFee: body.entertainmentFee ? parseInt(body.entertainmentFee) : null,
        advertisingFee: body.advertisingFee ? parseInt(body.advertisingFee) : null,
        bookFee: body.bookFee ? parseInt(body.bookFee) : null,
