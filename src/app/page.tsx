      ...
      <footer className="bg-text-main text-secondary-50 py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          <div className="mb-12 text-center">
            ...
            >
              <div className="w-14 h-14 bg-[#06C755] rounded-2xl flex items-center justify-center shadow-lg transform group-hover:scale-105 transition-transform">
              ...
              <div className="text-center">
                <p className="text-sm text-secondary-200 font-medium mb-1">公式LINEで相談する</p>
                <p className="text-xs text-secondary-400">ご要望やご質問はお気軽に</p>
              </div>
            </a>
          </div>
